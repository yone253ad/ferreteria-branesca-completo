  ...
  return (
    <div>
      <SEO 
        ...
        description="Ferretería Branesca - Calidad y Precio en herramientas y construcción." 
      />
      
      {/* HERO SECTION (Centrado y Restaurado) */}
      {!searchTerm && (
      ...
      <Container className="pb-5 mt-4">
        ...
        {productosFiltrados.length === 0 && (
            <div className="text-center py-5">
                ...
                <p className="text-muted">Intenta con otra palabra clave.</p>
                <Link to="/" className="btn btn-outline-primary mt-3 text-decoration-none">Ver todo el catálogo</Link>
            </div>
        )}
